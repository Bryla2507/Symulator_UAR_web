...
Q_CONSTINIT static const qt_meta_stringdata_CLASSFileManagerENDCLASS_t qt_meta_stringdata_CLASSFileManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 12),  // "saveInstance"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 8),  // "filePath"
        QT_MOC_LITERAL(35, 12)   // "loadInstance"
    },
    "FileManager",
    "saveInstance",
    "",
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->saveInstance((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->loadInstance((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
